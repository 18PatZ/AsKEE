...
//    }
    ...
    private WebView buildWebView()
    {
        ...
        webView.getEngine().loadContent("<p>hi</p>");//.load(url);
        return webView;
    }
    ...
    public void start(final Stage stage) throws Exception
    {
        ...
        final Map<String,String> titleToUrl = new HashMap<>();
        titleToUrl.put("Inspired by Actual Events", "http://marxsoftware.blogspot.com/");
        titleToUrl.put("JavaWorld", "http://javaworld.com/");
        titleToUrl.put("Java.net", "http://java.net/");
        titleToUrl.put("Java Lobby", "http://javalobby.com/");
